...
WerftService.Login = {
  ...
  requestStream: false,
  responseStream: true,
  requestType: werft_pb.LoginRequest,
  responseType: werft_pb.LoginResponse
};
...
WerftServiceClient.prototype.login = function login(requestMessage, metadata) {
  var listeners = {
    data: [],
    end: [],
    status: []
  };
  var client = grpc.invoke(WerftService.Login, {
